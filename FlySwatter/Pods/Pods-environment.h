...
// FHTTPClient
#define COCOAPODS_POD_AVAILABLE_FHTTPClient
#define COCOAPODS_VERSION_MAJOR_FHTTPClient 0
#define COCOAPODS_VERSION_MINOR_FHTTPClient 0
#define COCOAPODS_VERSION_PATCH_FHTTPClient 4
